  ...
  return room &&  (
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability.
            You get a comforgetable two bedrooms apartment has a true city feeling.The 
            price quoted is for two guests, at the guests slot please mark the number of guests 
            to get the exact price for groups. The guest will be allocated ground floor according to availability
            you get the comforgetable two bedroom apartment that has a true city feeling.</p> 
    </div>
    ...
    <div className='flex flex-col items-start gap-4'>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hoveer:bg-primary-dull transition-all cursor-pointer'>Contact Now</button>
    </div>
